    ...
    <article class="tmContentBlock pt-7 pb-7 pt-md-10 pb-md-10 pt-lg-16 pb-lg-16 pt-xl-22 pb-xl-22">
        <div class="container">
                ...
                <div class="px-5 pt-6 pb-6 descrWrap flex-grow-1 px-xl-12 pt-xl-9 pb-xl-12">
                    <div class="row">
                        <div class="col-12 col-md-5">
                            <h2 class="mb-1 fwMedium h3Small">H.E. KENNETH MAKELO LUSAKA</h2>
                            <h3 class="text-secondary fwSemiBold fontBase">THE GOVERNOR, BUNGOMA COUNTY</h3>
            ...
            <div class="mb-2 row mt-7 mt-md-10">
                ...
                <div class="col-12 col-lg-6">
                    <h2 class="mb-5 h2vii fwSemiBold">Professional Skills</h2>
                    <ul class="list-unstyled skillsRankList">
                        <li>
                            <div class="progresWrap">
                                <div class="mb-3 prgTopWrap text-lDark d-flex">
                                    <div class="wrap">
                                ...
                                <div class="bg-white progress-bar position-relative" id="progress-bar">
            ...
            <div class="ctFormWrap mt-7 mt-md-9">
                <h2 class="mb-4 h2vii fwSemiBold mb-md-7">Contact Me</h2>
